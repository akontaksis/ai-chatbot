...
function cacb_enqueue_assets() {
    ...
    wp_localize_script( 'cacb-chat', 'cacbConfig', [
        ...
        'wcEnabled'      => function_exists( 'wc_get_products' ) ? '1' : '',
...
function cacb_render_chat_html() {
    ...
    ?>
    <div id="cacb-wrapper" class="<?php echo esc_attr( $pos_class ); ?>" style="--cacb-primary:<?php echo esc_attr( $color ); ?>;" aria-label="<?php esc_attr_e( 'AI Chatbot', 'smart-ai-chatbot' ); ?>" role="complementary">

        <!-- Bubble button -->
        <button id="cacb-bubble" type="button" aria-label="<?php esc_attr_e( 'Άνοιγμα chatbot', 'smart-ai-chatbot' ); ?>" aria-expanded="false" aria-controls="cacb-window">
        ...
        <!-- Chat window -->
        <div id="cacb-window" role="dialog" aria-modal="true" aria-label="<?php esc_attr_e( 'Chat', 'smart-ai-chatbot' ); ?>" hidden>
            <div id="cacb-header">
                ...
                <button id="cacb-clear-btn" type="button" aria-label="<?php esc_attr_e( 'Καθαρισμός συνομιλίας', 'smart-ai-chatbot' ); ?>">
                ...
                <button id="cacb-close-btn" type="button" aria-label="<?php esc_attr_e( 'Κλείσιμο', 'smart-ai-chatbot' ); ?>">
            ...
            <div id="cacb-privacy">
                ...
                <a href="<?php echo esc_url( $privacy_url ); ?>" target="_blank" rel="noopener noreferrer">
                    <?php esc_html_e( 'Πολιτική Απορρήτου', 'smart-ai-chatbot' ); ?>
                </a>
                <?php endif; ?>
            </div>
            <?php endif; ?>

            <div id="cacb-messages" role="log" aria-live="polite" aria-label="<?php esc_attr_e( 'Μηνύματα', 'smart-ai-chatbot' ); ?>"></div>

            <div id="cacb-typing" hidden aria-label="<?php esc_attr_e( 'Ο βοηθός γράφει', 'smart-ai-chatbot' ); ?>">
            ...
            <div id="cacb-input-area">
                <textarea id="cacb-input"
                          rows="1"
                          maxlength="1000"
                          placeholder="<?php esc_attr_e( 'Γράψτε το μήνυμά σας…', 'smart-ai-chatbot' ); ?>"
                          aria-label="<?php esc_attr_e( 'Μήνυμα', 'smart-ai-chatbot' ); ?>"></textarea>
                <button id="cacb-send" type="button" aria-label="<?php esc_attr_e( 'Αποστολή', 'smart-ai-chatbot' ); ?>">
